""" old style -- moved Params and MinimalAdjudicationParameters here -- to be deprecated"""
import sys
import os
import random
import pickle
...
class Params(object):
    def __init__(self):
        ...
        self.USE_QC = True             # set to False if you just want to use e.g. simulated annealer
